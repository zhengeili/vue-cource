  ...
  <div class="menu-box">
    <!-- <a-menu>
      ...
      <a-submenu>
        ...
        <a-submenu>
          <div slot="title">3333-2</div>
          <a-menu-item>3333-2-11</a-menu-item>
          <a-menu-item>3333-2-22</a-menu-item>
        </a-submenu>
      </a-submenu>
    </a-menu> -->
    <a-menu>
      <template v-for="(item, index) in list">
        ...
        <re-submenu v-else :key="`mennu_item_${index}`" :parent="item" :index="index"></re-submenu>
      </template>
    </a-menu>
  </div>
</template>
